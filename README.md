...
- [x] SLM otomatik yeniden deneme: Ollama'nın alt süreci (llama-server) nadiren çöküyor (ör. segfault) - bu durumda süreç tamamen öldürülüp taze başlatılarak 1 kez daha denenir, çoğu geçici çökme ikinci denemede düzeliyor.
